...
@XmlSeeAlso({
	ee.ttu.idu0080.hinnakiri.types.ObjectFactory.class,
	HinnakiriNumberFormatFault.class, 
	HinnakiriNegativeNumberFormatFault.class, 
	HinnakiriZeroFault.class, 
...
public interface HinnakiriService {
    ...
    throws 
    	HinnakiriNumberFormatException, 
    	HinnakiriNegativeNumberFormatException, 
    	HinnakiriZeroException, 
    	HinnakiriPrecisionException;
}
