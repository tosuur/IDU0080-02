...
public class HinnakiriServiceImpl implements HinnakiriService {
	...
	throws HinnakiriNumberFormatException, HinnakiriNegativeNumberFormatException, HinnakiriZeroException, HinnakiriPrecisionException {
		...
		if (maximumPrice < 0){
			throw new HinnakiriNegativeNumberFormatException();
		}
